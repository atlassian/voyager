...
// DeepCopyShape is an autogenerated deepcopy function, copying the receiver, creating a new wiringplugin.Shape.
func (in *EnvironmentVariables) DeepCopyShape() wiringplugin.Shape {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EnvironmentVariablesData) DeepCopyInto(out *EnvironmentVariablesData) {
	*out = *in
	if in.EnvVars != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnvironmentVariablesData.
func (in *EnvironmentVariablesData) DeepCopy() *EnvironmentVariablesData {
	if in == nil {
		return nil
	}
	out := new(EnvironmentVariablesData)
	in.DeepCopyInto(out)
	return out
}
